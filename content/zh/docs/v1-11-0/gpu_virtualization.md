...
参考[Volcano vGPU设备插件](https://github.com/Project-HAMi/volcano-vgpu-device-plugin?tab=readme-ov-file#enabling-gpu-support-in-kubernetes)。
...
> **警告：** *如果在使用设备插件和NVIDIA镜像时未申请GPU，节点上的所有GPU都会暴露在容器内。*
