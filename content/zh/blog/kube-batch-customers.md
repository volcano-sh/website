...
| 组织                                 | 联系方式 (Github 用户名)                         | 环境     | 用户描述                                       |
| ------------------------------------ | ------------------------------------------------ | -------- | ---------------------------------------------- |
| [百度](https://www.baidu.com)        | [@tizhou86](https://github.com/tizhou86)         | 生产环境 | 自研机器学习框架 PaddlePaddle 的离线训练调度器 |
| [图森未来](https://www.tusimple.com) | [@suleisl2000](https://github.com/suleisl2000)   |          | MXNet 离线训练的调度器                         |
