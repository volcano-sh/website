...
设计文档：**[Network Topology Aware Scheduling](/docs/KeyFeatures/NetworkTopologyAware)**。

使用文档：**[Network Topology Aware Scheduling | Volcano](/docs/KeyFeatures/NetworkTopologyAware)**。
...
使用文档: **[Hierarchica Queue | Volcano](/docs/KeyFeatures/HierarchicalQueue)**。
...
关于Volcano Global的详细部署和使用指导，请参考: **[Multi-Cluster AI Job Scheduling | Volcano](/docs/KeyFeatures/MultiClusterScheduling)**。
...
关于Volcano云原生混部的详细设计和使用文档，请参考: **[Cloud Native Colocation | Volcano](/docs/KeyFeatures/cloudNativeColocation)**。
...
关于负载感知重调度的使用说明，请参考: **[Load-aware Descheduling | Volcano](/docs/KeyFeatures/LoadAwareDescheduling)**。
...
关于Volcano Job的详细设计和说明文档，请参考: **[How to use job policy](/docs/UserGuide/user_guide_how_to_use_job_policy)**。
...
Volcano Job和Job内的task同时支持配置PriorityClass，关于两个PriorityClass的配合关系以及配置样例请参考: **[how to configure priorityclass for job](/docs/UserGuide/user_guide_how_to_configure_priorityclass_for_job)**。
