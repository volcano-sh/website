...
description: 'New Features: Network topology-aware scheduling, Elastic hierarchical
  queues, Multi-cluster AI job scheduling, online/offline workloads colocation with
  dynamic resource oversubscription, Load-aware descheduling, Fine-grained job fault
  recovery policies, Volcano Dashboard for resource visualization, Supports for Kubernetes
  v1.31, Volcano Job supports for Preemption Policy, and Performance optimizations
...
tags:
- Practice
summary: 'New Features: Network topology-aware scheduling, Elastic hierarchical queues,
  Multi-cluster AI job scheduling, online/offline workloads colocation with dynamic
  resource oversubscription, Load-aware descheduling, Fine-grained job fault recovery
  policies, Volcano Dashboard for resource visualization, Supports for Kubernetes
  v1.31, Volcano Job supports for Preemption Policy, and Performance optimizations
  for large-scale scenarios'
...
A HyperNode represents a network topology performance domain, typically mapped to a switch. Multiple HyperNodes connect hierarchically to form a tree structure. For example:
 ...
 ![](/img/network-topology/hypernode-example.png)
...
![](/img/hierarchical-queue-example.png)
...
4. **Multi-Tenant Fair Scheduling:** Provides fair resource allocation across tenants, preventing resource contention.
 ...
 ![](/img/multi-cluster/volcano_global_design.svg)
...
**Enhanced OS:** Volcano implements fine-grained QoS guarantees at the kernel level, using cgroups to set resource limits for online and offline workloads, ensuring online workloads receive sufficient resources even under high load.
 ...
 ![](/img/colocation/architecture.png)
Architecture
...
- **Hotspot Node Management:** Migrates Pods from overloaded nodes to ensure stability.
 ...
 ![](/img/descheduler/descheduler_EN.svg)
