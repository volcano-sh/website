...
description = "Kthena is a Kubernetes-native, high-performance LLM inference routing and orchestration system. It improves GPU/NPU utilization and reduces latency with topology-aware scheduling, KV Cache-aware routing, and Prefill-Decode disaggregation."
subtitle = ""
...
<div style={{textAlign: 'center'}}> <img src="/kthena/kthena-arch.svg" />
</div>
...
<div style={{textAlign: 'center'}}> <img src="/kthena/model-serving.svg" />
</div>
...
<div style={{textAlign: 'right', marginBottom: '1rem'}}>—— <strong>Xiaobo Qi</strong>, Director of General Computing Services, Huawei Cloud</div>
...
<div style={{textAlign: 'right', marginBottom: '1rem'}}>—— <strong>Lei Yang</strong>, PaaS R&D Director, China Telecom AI</div>
...
<div style={{textAlign: 'right', marginBottom: '1rem'}}>—— <strong>Paco Xu</strong>, Open Source Team Lead at DaoCloud, Member of Kubernetes Steering Committee</div>
...
<div style={{textAlign: 'right', marginBottom: '1rem'}}>—— <strong>Kong Gu (Huachang Chen)</strong>, Cloud Native Business Gateway Lead, Xiaohongshu</div>
...
<div style={{textAlign: 'right', marginBottom: '1rem'}}>—— <strong>Zhaoxu Lu</strong>, Team Lead, Intelligent Computing Center, China Unicom Cloud</div>
...
<div style={{textAlign: 'right', marginBottom: '1rem'}}>—— <strong>Kevin Wang</strong>, Volcano Maintainer, CNCF TOC Vice Chair</div>
