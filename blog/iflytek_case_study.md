---
title: iFlytek Enhances AI Infrastructure with Volcano, Wins CNCF End-User Case Study
  Award
description: iFlytek was awarded for its innovative use of Volcano in the CNCF End-User
  Case Study Competition and shared its success in large-scale AI model training at
...
tags:
- News
summary: iFlytek was awarded for its innovative use of Volcano in the CNCF End-User
  Case Study Competition and shared its success in large-scale AI model training at
  KubeCon + CloudNativeCon China 2025.
linktitle: iFlytek Enhances AI Infrastructure with Volcano, Wins CNCF End-User Case
  Study Award
parent: news
weight: '6'
---

 ![](/img/kubecon/iflytek.jpeg)
