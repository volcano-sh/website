...
description: 'New features: Support for vGPU scheduling and isolation, support for
  vGPU and user-defined resource preemption capabilities, addition of JobFlow workflow
  scheduling engine, node load-aware scheduling and rescheduling support for diverse
  monitoring systems, optimization of Volcano''s ability to schedule microservices,
  optimization of Volcano charts packages for publishing and archiving, etc.'
subtitle: ''
date: 2024-01-31
lastmod: '2024-01-31'
datemonth: Jan
...
tags:
- Practice
summary: 'New features: Support for vGPU scheduling and isolation, support for vGPU
  and user-defined resource preemption capabilities, addition of JobFlow workflow
  scheduling engine, node load-aware scheduling and rescheduling support for diverse
  monitoring systems, optimization of Volcano''s ability to schedule microservices,
  optimization of Volcano charts packages for publishing and archiving, etc.'
