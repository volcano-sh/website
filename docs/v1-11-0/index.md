...
## Features
### [Unified Scheduling](/docs/unified_scheduling/)
...
### [Queue Resource Management](/docs/queue_resource_management/)
...
* Kunpeng
* Ascend
* GPU: Supports [GPU virtualization](/docs/v1-11-0/gpu_virtualization/) functionality, providing fine-grained GPU resource management
