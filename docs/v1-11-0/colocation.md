...
<div style={{textAlign: 'center'}}> <img src="/colocation/architecture.png" />
Architecture
</div>
...
<div style={{textAlign: 'center'}}> <img src="/colocation/oversubscription_EN.png" />Dynamic Resource OverSubscription Diagram</div>
...
<div style={{textAlign: 'center'}}> <img src="/colocation/network.png" />
...
<div style={{textAlign: 'center'}}> <img src="/colocation/watermark.png" />
...
<div style={{textAlign: 'center'}}> <img src="/colocation/cpu-burst1-EN.png" />
</div>

When CPU Burst is enabled, the container's CPU usage can exceed the limit, enabling bursting. As shown below:

<div style={{textAlign: 'center'}}> <img src="/colocation/cpu-burst2-EN.png" />
</div>
...
<table>
  <thead>
    <tr>
      <th style={{textAlign: 'center'}}>Watermark</th>
