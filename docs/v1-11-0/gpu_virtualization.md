...
<div style={{textAlign: 'center'}}> <img src="/gpu-virtualization/hard_limit.jpg" />
</div>
...
```
<div style={{textAlign: 'center'}}> <img src="/gpu-virtualization/vgpu_device_plugin_metrics.png" />
</div>
